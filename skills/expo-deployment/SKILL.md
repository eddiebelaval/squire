...
description: Deploying Expo apps to iOS App Store, Android Play Store, web hosting, and CI/CD workflows using EAS (Expo Application Services).
version: 1.0.0
category: mobile-development
complexity: complex
author: "James Ide (Expo)"
license: MIT
triggers:
  - "expo deploy"
  - "expo build"
